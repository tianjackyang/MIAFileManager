...
{
    return [[MIAFileManager pathForApplicationSupportDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[MIAFileManager pathForCachesDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[MIAFileManager pathForDocumentsDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[MIAFileManager pathForLibraryDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[MIAFileManager pathForMainBundleDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[MIAFileManager pathForTemporaryDirectory] stringByAppendingPathComponent:path];
}
